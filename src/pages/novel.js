              ...
              <div className="novel-detail">
                ...
                <div className="black">
                  ...
                  {novelDetail.Categories
                    ? categories[novelDetail.Categories]
                    : "暂无"}
                </div>
                <div>
                  <span>状态：</span>
                  {novelState[novelDetail.Status]}
                </div>
                <div>
                  <span>更新：</span>
                  {GMTToStr(novelDetail.UpdatedAt)}
                </div>
                <div className="black">
                  <span>最新：</span>
                  {novelDetail.NewUpdateChapter
                    ? novelDetail.NewUpdateChapter
                    : "暂无"}
                </div>
              </div>
...
export default connect(
  mapStateToProps,
  { setNovelDetailAsync, setNovelChapterAsync }
)(NovelItem);
